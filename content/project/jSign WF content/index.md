---
title: Leading a Teamwide Shift to Microcontent Using Whatfix  
date: 2022-06-20  
toc: false  
tags:  
summary: Led a collaborative transition from traditional documentation to embedded microcontent for a web app using Whatfix  
---
...
From: [original article](https://docs.jsign.com/help/webapp/thedashboardpg/uplddcmts.htm)  
![screen reader text](jsignarticle1.png)

**2. Indicating Who Should Sign**  
From: [original article](https://docs.jsign.com/help/webapp/themanagepg/indctwhowhr2sgn.htm)  
![screen reader text](jsignarticle2.png)

**3. Adding Contact Info**  
From: [original article](https://docs.jsign.com/help/webapp/thecontactspg/entrcntctsinfo.htm)  
